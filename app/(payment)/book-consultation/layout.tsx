...
export default function Layout({
  ...
  return (
    <main className="grid lg:grid-cols-3 lg:flex-1">
      <section className="bg-[#F6F9FC] w-full border-r border-[#EFF2F5]">
        <div className="lg:pt-28 mx-auto w-full px-4 py-8 lg:ml-4">
      ...
      <section className="lg:col-span-2 lg:p-28 px-4 py-8">{children}</section>
    </main>
  );
}
